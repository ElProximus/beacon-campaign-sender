...
class Bcsend_Privacy {
	...
	public static function add_privacy_policy_content() {
		...
		$content .= '<p>' . esc_html__( 'Beacon Campaign Sender honors WordPress personal data export and erasure requests for subscriber, email log, and push device records stored locally by the plugin.', 'beacon-campaign-sender' ) . '</p>';
